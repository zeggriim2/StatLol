...
use App\Repository\RangeSpellRepository;

/**
 * @ORM\Entity(repositoryClass=RangeSpellRepository::class)
 */
class RangeSpell
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity=Spell::class, mappedBy="rangeSpell", cascade={"persist", "remove"})
     */
    private ?Spell $spell;
    ...
    public function setSpell(?Spell $spell): self
    {
        ...
        if ($spell === null && $this->spell !== null) {
            $this->spell->setRangeSpell(null);
        }

        // set the owning side of the relation if necessary
        if ($spell !== null && $spell->getRangeSpell() !== $this) {
            $spell->setRangeSpell($this);
        }
